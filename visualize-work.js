...
const screenshotsDir = path_1.default.join(__dirname, 'screenshots-showcase');
...
async function captureScreenshot(page, name, description) {
  ...
  await page.screenshot({
    path: path_1.default.join(screenshotsDir, `${name}.png`),
    fullPage: true,
  });
...
async function visualizeWork() {
  ...
  try {
    ...
    await captureScreenshot(
      page,
      '01-landing-hero',
      'Landing page with modern hero section and custom logo'
    );
    ...
    await captureScreenshot(
      page,
      '06-bookmakers-page',
      'Bookmakers comparison with ratings and offers'
    );
    // 5. Ambassadors Page
...
<body>
  ...
  <div class="container">
    ...
    fs_1.default.writeFileSync(path_1.default.join(screenshotsDir, 'showcase.html'), htmlContent);
